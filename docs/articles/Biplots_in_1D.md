...
This is a base graphics feature, so it requires `plot(engine = "base")`.

[`biplot`](../reference/biplot.md)`(``iris``)`` ``|>`` `[`PCA`](../reference/PCA.md)`(``group.aes ``=`` ``iris``[``,``5``]``,dim.biplot ``=`` ``1``, show.class.means ``=`` ``TRUE``)`` ``|>`` `` `[`axes`](../reference/axes.md)`(``col``=``"black"``)`` ``|>`` `[`density1D`](../reference/density1D.md)`(``)`` ``|>`` `[`samples`](../reference/samples.md)`(``opacity``=``0.5``)``|>`` `[`alpha.bags`](../reference/alpha.bags.md)`(``)``|>`` `` `[`legend.type`](../reference/legend.type.md)`(``samples ``=`` ``TRUE``,means ``=`` ``TRUE``, bags ``=`` ``TRUE``, new``=``TRUE``)`` ``|>`` `[`plot`](https://rdrr.io/r/graphics/plot.default.html)`(``engine ``=`` ``"base"``)`` ``#> Computing 0.95 -bag for setosa `` ``#> Computing 0.95 -bag for versicolor `` ``#> Computing 0.95 -bag for virginica`
...
`bp`` ``<-`` `[`biplot`](../reference/biplot.md)`(``iris``)`` ``|>`` `[`CVA`](../reference/CVA.md)`(``classes ``=`` ``iris``[``,``5``]``,dim.biplot ``=`` ``1``, show.class.means ``=`` ``TRUE``)`` ``|>`` `` `[`axes`](../reference/axes.md)`(``col``=``"black"``)`` ``|>`` `[`classify`](../reference/classify.md)`(``)`` ``|>`` `[`density1D`](../reference/density1D.md)`(``)`` ``|>`` `[`samples`](../reference/samples.md)`(``opacity``=``0.5``)``|>`` `[`alpha.bags`](../reference/alpha.bags.md)`(``)``|>`` `` `[`legend.type`](../reference/legend.type.md)`(``samples ``=`` ``TRUE``,means ``=`` ``TRUE``, bags ``=`` ``TRUE``, regions ``=`` ``TRUE``, new``=``TRUE``)`` ``|>`` `[`plot`](https://rdrr.io/r/graphics/plot.default.html)`(``engine ``=`` ``"base"``)`` ``#`` ``#> Computing 0.95 -bag for setosa `` ``#> Computing 0.95 -bag for versicolor `` ``#> Computing 0.95 -bag for virginica`
