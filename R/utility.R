...
#' Applies primary or secondary approach to ties
#'
#' @param d observed dissimilarities
#' @param delta given dissimilarities to match (order)
#' @param method either \code{primary} or \code{secondary} approach to ties
#'
#' @returns a vector of ordered values
#'
